...
<head>
  ...
  <link rel="icon" href="..\..\..\favicon.ico"><!--begin::Fonts--><!--end::Fonts--><!--begin::Third Party Plugin(OverlayScrollbars)-->
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary"> <!--begin::App Wrapper-->
      ...
      <div class="sidebar-wrapper">
        <nav class="mt-2"> <!--begin::Sidebar Menu-->
          <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($_SESSION['role'] != "superadmin") : ?>
              <li class="nav-item"> <a href="./top_students.php" class="nav-link active"> <i class="bi bi-star"></i>
                  <p>Top Students</p>
                </a> </li>
            <?php endif; ?>
            <?php if ($_SESSION['role'] == "superadmin") : ?>
        ...
        <div class="container-fluid"> <!--begin::Row-->
          <div class="row">
            <div class="card p-3">
              ...
              <table class="table table-bordered table-striped table-responsive w-100" id="top-students-table">
                <thead>
                  <tr>
                    <th>Full Name</th>
                    <th>Total Visits</th>
  ...
  <!-- ScRriptz -->
  <script src="top_students.js"></script>
</body>
